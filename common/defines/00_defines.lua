...
NDiplomacy = {
	...
	BASE_PEACE_TAKE_UNCONTROLLED_STATE_FACTOR = 50.0, -- Base factor for taking state you do not control
	...
	-- Vanilla is 1.35
	PEACE_SCORE_SCALE_FACTOR = 3.0,                -- Losers' total value times this factor becomes the default total peace conference score that is distributed to the winners.
	...
	PEACE_SCORE_DISTRIBUTION = { 0.3, 0.3, 0.3, 0.3, 0.3 }, -- How much of the total peace conference score you get during the first n turns.
...
NCountry = {
	...
	STATE_VALUE_BASE = 1.0,                        -- Base value of a state (value is used to determine costs in e.g. peace conferences)
	STATE_VALUE_BUILDING_SLOTS_MULT = 1.0,          -- The value of each building slot in a state
	STATE_VALUE_MANPOWER_FACTOR = 0.05,              -- State cost increases with this for every 10k population (so 3.1M becomes 310 and then multiplied by this)
